...
const Fig1 = () => {
    return (
        <svg className='w-8 h-8' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
            ...
            <path d="M2 17L12 22L22 17" fill="url(#gradient2)" strokeWidth="2" strokeLinecap='round' strokeLinejoin='round' />
            <path d="M2 12L12 17L22 12" fill="url(#gradient2)" strokeWidth="2" strokeLinecap='round' strokeLinejoin='round' />
            <defs>
